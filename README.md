...
- **[SQL Server](https://www.microsoft.com/en-us/sql-server/sql-server-downloads):** Microsoft SQL Server for hosting your SQL database.
...
│   │   └── ddl_bronze.sql             # Bronze layer DDL scripts
